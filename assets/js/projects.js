const PROJECTS = [
  {
    ...
    image: 'assets/img/lempstack.jpg',
      ...
      <div class="fade-in">
        ...
        ${p.errors.map(e => `
          <div class="proj-error">
            ...
            <div style="color:var(--text-dim);font-size:12px;margin-top:4px">Fix: ${e.fix}</div>
          </div>
        `).join('')}
